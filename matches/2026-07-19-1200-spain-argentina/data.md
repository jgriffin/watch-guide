# Spain vs Argentina — 2026 FIFA World Cup, THE FINAL (Match 104) · 2026-07-19
<!-- Watch-guide research sidecar. Source of truth; spain-argentina.html is rendered from this. -->
...
## Spine
- Kickoff: **12:00 PM PDT** (3:00 PM EDT · East Rutherford — Eastern time)  ·  Date: 2026-07-19 (Sun)
- Venue: **MetLife Stadium**, East Rutherford, NJ — the 2026 World Cup **final** venue (~82,500), open-air, home of the NY Giants/Jets
- TV: **FOX** (Eng) · **Telemundo** (Spa)  ·  Referee: not recorded here (final officials not asserted — not invented)
- Home — **Spain** · "La Roja" / "La Furia Roja" · FIFA **#2** (cleanly sourced) · Coach: **Luis de la Fuente** · **4-3-3** (reigning Euro 2024 & 2023 Nations League champions)
- Away — **Argentina** · "La Albiceleste" · FIFA **world No. 1** (reigning champions; phrased as No. 1, not a dated table) · Coach: **Lionel Scaloni** · **4-3-3**
- Designated "home" (left) = Spain per the site fixture; the final is a neutral-venue single match.
...
## How They Got Here (route to the final — R32 → Semi-final)
- **Spain — Group H winners, then a flawless knockout run (conceded once all tournament):**
  - Group stage: 0-0 Cape Verde (D), 4-0 Saudi Arabia (W), 1-0 Uruguay (W)
  - **R32 · vs Austria · 3-0 (W)**
  - **R16 · vs Portugal · 1-0 (W)** — won the Iberian Derby, knocked out Ronaldo's Portugal
  - **QF · vs Belgium · 2-1 (W)** — the only goal Spain conceded in the knockouts
  - **SF · vs France · 2-0 (W)** — dismantled France to reach the final
- **Argentina — Group J winners (9 pts), then a survivor's run of narrow wins:**
  - Group stage: 3-0 Algeria (W), 2-0 Austria (W), 3-1 Jordan (W)
  - **R32 · vs Cape Verde · 1-1 a.e.t. (W)** — needed extra time to see off the debutants
  - **R16 · vs Egypt · 3-2 (W)** — a five-goal thriller past Salah's Egypt
  - **QF · vs Switzerland · 1-1 a.e.t. (W)** — another one that went the distance
  - **SF · vs England · 2-1 (W)** — edged England to reach a second straight final
...
- **Spain:**
  - **Lamine Yamal** · Barcelona · FW — **19**; the tournament's marquee teenager and the face of Spain's golden generation. Right-wing 1v1s and left-footed curlers; the heir to the No. 10 mantle just as Messi's era closes. A world champion at 19.
  - **Pedri** · Barcelona · MF — press-resistant midfield conductor and tempo-setter; Spain hum when he does. The metronome of a possession machine that won it all.
  - **Rodri** · Manchester City · MF / captain — **2024 Ballon d'Or** winner and the defensive-midfield anchor, back from a serious knee injury; the screen in front of Spain's back four and the lifter of the trophy.
  - **Unai Simón** · Athletic Bilbao · GK — the wall behind it all: Spain conceded just **once in the whole knockout phase** and shut out Argentina in the final. A champion goalkeeper's tournament.
- **Argentina:**
...
- Starters:
  - 23 · Unai Simón · GK · Athletic Bilbao
  - 12 · Pedro Porro · DF · Tottenham
  - 22 · Pau Cubarsí · DF · Barcelona
  - 14 · Aymeric Laporte · DF · Athletic Bilbao
  - 24 · Marc Cucurella · DF · Chelsea
  - 16 · Rodri (C) · MF · Manchester City
  - 20 · Pedri · MF · Barcelona
  - 10 · Dani Olmo · MF · Barcelona
  - 19 · Lamine Yamal · FW · Barcelona
  - 21 · Mikel Oyarzabal · FW · Real Sociedad
  - 15 · Álex Baena · MF · Atlético Madrid
- Bench:
  - 1 · David Raya · GK · Arsenal
  - 2 · Marc Pubill · DF · Atlético Madrid *(club unconfirmed)*
  - 3 · Alejandro Grimaldo · DF · Bayer Leverkusen
  - 4 · Eric García · DF · Barcelona
  - 5 · Marcos Llorente · DF · Atlético Madrid
  - 6 · Mikel Merino · MF · Arsenal
  - 7 · Ferran Torres · FW · Barcelona
  - 8 · Fabián Ruiz · MF · Paris Saint-Germain
  - 9 · Gavi · MF · Barcelona
  - 11 · Yeremy Pino · FW · Crystal Palace *(club unconfirmed)*
  - 13 · Joan García · GK · Barcelona *(club unconfirmed)*
...
- Note: XI carried from Argentina's R16 (Egypt) guide, the sourced 4-3-3 consensus. **Julián Álvarez (9)** — the Qatar 2022 hero — is Argentina's biggest bench weapon and a plausible starter over Almada in a final. Otamendi the veteran leader off the bench. Juan Foyth was OUT of the tournament (Achilles).

## Fun Facts / Quirks
- **Spain are world champions for the second time** — their first title since **2010** (Iniesta's goal vs the Netherlands), and a first for this golden generation on top of **Euro 2024** and the **2023 Nations League.**
- **Argentina fell one game short of back-to-back** — a feat **no nation has managed since Brazil in 1962** (Italy 1934-38 the only other). The runners-up medal ends the repeat bid.
...
## Colors
- Identity (header) — **Spain**: flag-red `#AA151B` / deep `#6f0d11` (gold `#F1BF00` accent). **Argentina**: sky blue `#5C9DD6` / deep `#2E6BA0` (gold-sun `#F6B40E` accent, the Sol de Mayo).
- Matchday kit (what they WORE — final home/away resolution): **Spain (designated home) in their home RED shirt** (lineup tinted red, red number chips). **Argentina in the iconic sky-blue-and-white striped home shirt** (lineup tinted sky-blue; number chips a deeper blue `#2E6BA0` so white numerals read cleanly against the light identity). Red vs sky-blue = **no clash**; both in home kits — the classic final look.
